...
<div class="footer">
<p>Developed with ❤ by Manikandan K and Livesh M</br>
</div>
"""
...
st.markdown(
    f"""
    <div class="container">
        <p class="logo-text"> &nbsp Text to Meme Generation</p>
    </div>
    """,
    unsafe_allow_html=True
)
...
st.write("MEMSYWelcome to text-to-meme generation engine. Enter any prompt and you will get 10 relevant meme templates to select from. Pick a template, and click on 'Generate Meme' to get a meme. We use GPT-3 to generate captions, so please enter your API key below!")
